...
public interface IWorkItemNotificationService
{
    ...
    IAsyncEnumerable<TaskEventEnvelope> SubscribeForAgentOrPersona(string agentId, string persona,
        CancellationToken ct = default);

    IAsyncEnumerable<TaskEventEnvelope> SubscibeForTaskCompletion(IReadOnlyList<string> taskIds,
        CancellationToken ct = default);
    ...
    ValueTask PublishTaskClaimed(string taskId, string? agentId, CancellationToken ct = default);
